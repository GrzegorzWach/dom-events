...
// B.1 - Za każdym kliknięciem na dowolny przycisk dopisz do diva clicked-info
// data-id kliknietego przycisku.

const b1 = () => {
  const div = document.querySelector('#clicked-info');
  const dataset = Array.document.querySelectorAll('button[data-id]');
  document.addEventListener('click', (e) => {
    

    div.innerText += dataset;
  });
}
